...
response = requests.post(f'{url}/main/em/org/saveUser?sysappid={sysAppId}', cookies=cookies, headers=headers, data=data)
...
# response = requests.post(f'{url}/main/em/org/exportOrg?syscorpid=123456&sysappid={sysAppId}', cookies=cookies, headers=headers, data=data)
